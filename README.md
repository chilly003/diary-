...
12. 개인 공간 들어가면 보이는 유저 상세 정보와 개인정보 수정 버튼이 있을거임 그거 컨테이너 한짝에 2칸이 들어가는 걸로 바꾸기 9대 3이면 될듯

13. 이미지가 없어서 업로드 안한거면 기본이미지 넣어주는 작업 필요

14. 게시글에 대한 좋아요 기능 추가

15. 프로필 페이지 들어가면 내가 프로필 수정, 내가 작성한 글, 댓글, 좋아요한 글 보이게 만들기
